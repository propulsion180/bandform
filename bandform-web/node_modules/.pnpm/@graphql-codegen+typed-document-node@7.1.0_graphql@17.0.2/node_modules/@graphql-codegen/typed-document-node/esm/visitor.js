...
import { ClientSideBaseVisitor, DocumentMode, typedDocumentString, } from '@graphql-codegen/visitor-plugin-common';
export class TypeScriptDocumentNodesVisitor extends ClientSideBaseVisitor {
    ...
    constructor(schema, fragments, config, documents) {
        ...
        if (this.config.documentMode === DocumentMode.graphQLTag) {
            ...
            const tagImport = this._generateImport(typedDocumentString.import, typedDocumentString.import.propName, true);
            this._imports.add(tagImport);
        }
    }
